 ...
 * @see Operation
 * @see com.gzcxadfzc.nationalAssembly.response.JsictionComiteProcessListResponse
 * @see com.gzcxadfzc.nationalAssembly.response.item.JsictionComiteProcessListItem
 */
@Data
@Builder
